...
VOID MainProc()
{
	...
	(
		false,			// true if you want to hook windows libraries (besides mutex) set this to false if you already edited your IP into the client (eg v83 localhosts)
		MainFunc,		// function to be executed after client is unpacked
		"158.247.232.199",	// IP to connect to (your server IP)
		"158.247.232.199"		// IP to redirect from (nexon IP)
	);
}
